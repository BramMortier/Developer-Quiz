...
// Quiz settings logic
var quizSettings = {
  amountOfQuestions: Number(_constants__WEBPACK_IMPORTED_MODULE_1__.amountOfQuestions.innerText),
  possibleAnswers: Number(_constants__WEBPACK_IMPORTED_MODULE_1__.possibleAnswers.innerText),
  tipsOn: _constants__WEBPACK_IMPORTED_MODULE_1__.tipsAllowed.innerText === "Off" ? false : true,
  timelimitOn: _constants__WEBPACK_IMPORTED_MODULE_1__.timelimitActivated.innerText === "Off" ? false : true,
  difficulty: "Easy"
};
...
var updateAnswerStorage = function updateAnswerStorage(questionIndex, selectedAnswer, correctAnswer) {
  var answerStorageCurrent = _globals__WEBPACK_IMPORTED_MODULE_2__.getAnswerStorage();
  answerStorageCurrent[questionIndex - 1] = {
    selectedAnswer: selectedAnswer,
    correctAnswer: correctAnswer
  };
  _globals__WEBPACK_IMPORTED_MODULE_2__.setAnswerStorage(answerStorageCurrent);
};
...
var highlightSelectedAnswer = function highlightSelectedAnswer(questionIndex) {
  var selectedIndex = _globals__WEBPACK_IMPORTED_MODULE_2__.getAnswerStorage()[questionIndex - 1].selectedAnswer;
  if (selectedIndex == undefined) return;
  _toConsumableArray(_constants__WEBPACK_IMPORTED_MODULE_1__.answerList.children).map(function (el, index) {
...
var renderQuestionNavigation = function renderQuestionNavigation(questions) {
  _constants__WEBPACK_IMPORTED_MODULE_1__.questionNav.innerHTML = "";
  questions.map(function (question, index) {
    var questionNumberEl = document.createElement("li");
    if (index === _globals__WEBPACK_IMPORTED_MODULE_2__.getQuestionIndex() - 1) questionNumberEl.classList.add("question__number--selected");
    questionNumberEl.classList.add("question__number");
    questionNumberEl.addEventListener("click", function (e) {
      _globals__WEBPACK_IMPORTED_MODULE_2__.setQuestionIndex(Number(e.target.innerText) > 9 ? Number(e.target.innerText) : Number(e.target.innerText.slice(1)));
      displayQuestion(_globals__WEBPACK_IMPORTED_MODULE_2__.getQuizData());
      highlightSelectedAnswer(_globals__WEBPACK_IMPORTED_MODULE_2__.getQuestionIndex());
    });
    questionNumberEl.innerText = index >= 9 ? index + 1 : "0".concat(index + 1);
    _constants__WEBPACK_IMPORTED_MODULE_1__.questionNav.appendChild(questionNumberEl);
  });
};
var displayQuestion = function displayQuestion(data) {
  ...
  currentQuestionAnswers.map(function (answer, index) {
    if (answer !== null) {
      ...
      _constants__WEBPACK_IMPORTED_MODULE_1__.answerList.appendChild(answerEl);
      answerEl.addEventListener("click", function () {
        updateAnswerStorage(_globals__WEBPACK_IMPORTED_MODULE_2__.getQuestionIndex(), index, correctAnswer);
        highlightSelectedAnswer(_globals__WEBPACK_IMPORTED_MODULE_2__.getQuestionIndex());
      });
    }
  });
